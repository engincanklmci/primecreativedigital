...
const Home = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Prime Dijital - İşinizi Zirveye Taşıyan Prime Dokunuş</title>
        <meta name="description" content="Prime Dijital Ajans ile markanızı dijital dünyada güçlendirin. Web tasarım, yazılım, grafik tasarım ve dijital pazarlama çözümleri." />
        <meta name="keywords" content="dijital ajans, web tasarım, yazılım, grafik tasarım, seo, istanbul ajans" />
      </Helmet>
